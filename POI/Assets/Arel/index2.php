            ...
            <?php 
                ...
                foreach($M_POIS as $POI){
                  ...
                  echo '<strong>Latitud:</strong> '.$POI->Latitud.' y <strong>Longitud:</strong>'.$POI->Longitud.'<br/>';
                    ...
                    echo '<img onclick="mostrarAMULTI('.$POI->idPOI.');" src="http://realidadaumentada.ldc.usb.ve/ar0640386/Debug/Assets/Images/tmp/multimedia.png">';                                  
                    ...
                    foreach($Multimedias as $Multimedia){
                        ...
                        echo '<div class="mimpar">';
                            ...
                            echo '</info>';
                            echo '<img class="eliminarMULTI" onclick="eliminarMULTI('.$POI->idPOI.','.$Multimedia->idMultimedia.');" src="http://realidadaumentada.ldc.usb.ve/ar0640386/Debug/Assets/Images/tmp/delete.png">';    
                        echo '</div>' ;
                    }
                    echo '</div>';
                    $i = $i+1;
